...
All 27 distributions have `noexcept` move constructors and move assignment operators in v2.x. This ensures containers such as `std::vector<GaussianDistribution>` move rather than copy during reallocation.
