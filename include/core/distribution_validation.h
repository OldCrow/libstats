 ...
 */
bool hasSufficientVariance(const std::vector<double>& data, double min_variance = 1e-12) noexcept;
 ...
 */
std::string generateValidationRecommendations(const ValidationResult& result, size_t data_size);
