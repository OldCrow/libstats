...
class PoissonDistribution : public DistributionBase {
   public:
     ...
     *
     * @param x The value at which to evaluate the PMF (will be rounded to nearest non-negative
     * integer)
     ...
     *
     * @param x The value at which to evaluate the log-PMF (will be rounded to nearest non-negative
     * integer)
   ...
   private:
    ...
    void getProbabilityBatchUnsafeImpl(const double* values, double* results, std::size_t count,
                                       double lambda, double log_lambda,
    ...
    void getCumulativeProbabilityBatchUnsafeImpl(const double* values, double* results,
                                                 std::size_t count, double lambda) const noexcept;
