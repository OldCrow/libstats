...
class AdaptiveThresholdCalculator {
   ...
   public:
    AdaptiveThresholdCalculator() { arch_profile_ = detectArchitectureProfile(); }
     ...
     */
    std::size_t getThreshold(const std::string& distribution, const std::string& operation) const;
     ...
     */
    bool shouldUseParallel(const std::string& distribution, const std::string& operation,
     ...
     */
    void updateFromMeasurement(const std::string& distribution, const std::string& operation,
                               std::size_t data_size, bool parallel_beneficial);
};
...
inline bool shouldUseDistributionParallel(const std::string& distribution,
                                          const std::string& operation, std::size_t data_size) {
