...
class aligned_allocator {
   public:
    ...
    pointer allocate(size_type n) {
        ...
        constexpr size_type alignment =
            (SIMD_ALIGNMENT < sizeof(void*)) ? sizeof(void*) : SIMD_ALIGNMENT;
...
class VectorOps {
   public:
    ...
    /// @param size Number of elements
    static void vector_add(const double* a, const double* b, double* result,
    ...
    /// @param result Output vector (a - b)
    /// @param size Number of elements
    static void vector_subtract(const double* a, const double* b, double* result,
                                std::size_t size) noexcept;
    ...
    /// @param result Output vector (a * b)
    /// @param size Number of elements
    static void vector_multiply(const double* a, const double* b, double* result,
                                std::size_t size) noexcept;
    ...
    /// @param size Number of elements
    static void scalar_multiply(const double* a, double scalar, double* result,
                                std::size_t size) noexcept;
    ...
    static bool should_use_vectorized_path(std::size_t size, const void* data1,
                                           const void* data2 = nullptr,
                                           const void* data3 = nullptr) noexcept;
   ...
   private:
    ...
    static void vector_add_fallback(const double* a, const double* b, double* result,
                                    std::size_t size) noexcept;
    static void vector_subtract_fallback(const double* a, const double* b, double* result,
                                         std::size_t size) noexcept;
    static void vector_multiply_fallback(const double* a, const double* b, double* result,
                                         std::size_t size) noexcept;
    ...
    static void vector_add_avx512(const double* a, const double* b, double* result,
                                  std::size_t size) noexcept;
    static void vector_subtract_avx512(const double* a, const double* b, double* result,
                                       std::size_t size) noexcept;
    static void vector_multiply_avx512(const double* a, const double* b, double* result,
                                       std::size_t size) noexcept;
    static void scalar_multiply_avx512(const double* a, double scalar, double* result,
                                       std::size_t size) noexcept;
    ...
    static void vector_add_avx(const double* a, const double* b, double* result,
                               std::size_t size) noexcept;
    static void vector_subtract_avx(const double* a, const double* b, double* result,
                                    std::size_t size) noexcept;
    static void vector_multiply_avx(const double* a, const double* b, double* result,
                                    std::size_t size) noexcept;
    static void scalar_multiply_avx(const double* a, double scalar, double* result,
                                    std::size_t size) noexcept;
    ...
    static void vector_add_avx2(const double* a, const double* b, double* result,
                                std::size_t size) noexcept;
    static void vector_subtract_avx2(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void vector_multiply_avx2(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void scalar_multiply_avx2(const double* a, double scalar, double* result,
                                     std::size_t size) noexcept;
    ...
    static void vector_add_sse2(const double* a, const double* b, double* result,
                                std::size_t size) noexcept;
    static void vector_subtract_sse2(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void vector_multiply_sse2(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void scalar_multiply_sse2(const double* a, double scalar, double* result,
                                     std::size_t size) noexcept;
    ...
    static void vector_add_neon(const double* a, const double* b, double* result,
                                std::size_t size) noexcept;
    static void vector_subtract_neon(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void vector_multiply_neon(const double* a, const double* b, double* result,
                                     std::size_t size) noexcept;
    static void scalar_multiply_neon(const double* a, double scalar, double* result,
                                     std::size_t size) noexcept;
...
constexpr std::size_t align_size(std::size_t size,
                                 std::size_t alignment = SIMD_ALIGNMENT) noexcept {
