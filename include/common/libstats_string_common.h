...
namespace string_utils {
    ...
    inline std::string format_confidence_interval(double lower, double upper, double confidence_level = 0.95) {
        std::ostringstream oss;
    ...
    inline std::string format_distribution_params(const std::string& dist_name, 
