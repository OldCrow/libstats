...
bool should_use_parallel(const std::string& distribution, const std::string& operation,
...
template <typename Iterator, typename T>
typename std::iterator_traits<Iterator>::difference_type count(Iterator first, Iterator last,
                                                               const T& value);

/// Parallel count_if with automatic policy selection
template <typename Iterator, typename UnaryPredicate>
typename std::iterator_traits<Iterator>::difference_type count_if(Iterator first, Iterator last,
                                                                  UnaryPredicate pred);
...
enum class PolicyType { Sequential, Parallel, ParallelUnsequenced, VectorizedParallel };
