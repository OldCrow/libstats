...
**v2.0.1 is the current release.** v1.5.3 was the final v1.x release.
See [MIGRATION_GUIDE.md](MIGRATION_GUIDE.md) for breaking changes and upgrade instructions.

---

[![Version](https://img.shields.io/badge/version-v2.0.1-brightgreen.svg)](https://github.com/OldCrow/libstats/releases/tag/v2.0.1)
...
v2.0.1 is released. v1.5.3 was the final v1.x release.
