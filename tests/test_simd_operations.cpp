...
void test_runtime_detection() {
    ...
    cout << "  Family: " << features.family << ", Model: " << features.model << ", Stepping: " << features.stepping << endl;
}
...
void benchmark_performance() {
    ...
    cout << "Vector addition (" << iterations << " iterations, " << size << " elements): "
    ...
    cout << "Dot product (" << iterations << " iterations, " << size << " elements): "
         << duration.count() << " microseconds" << endl;
    ...
    cout << "Vector exp (" << iterations << " iterations, " << size << " elements): "
         << duration.count() << " microseconds" << endl;
}
