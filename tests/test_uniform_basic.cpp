...
int main() {
    ...
    try {
        ...
        cout << "This test verifies all ways to create Uniform distributions: default (0,1), parameterized (2,5)," << endl;
        ...
        if (result.isOk()) {
            ...
            StandardizedBasicTest::printProperty("Factory Lower Bound", factory_uniform.getLowerBound());
            StandardizedBasicTest::printProperty("Factory Upper Bound", factory_uniform.getUpperBound());
        }
        ...
        StandardizedBasicTest::printProperty("Atomic Lower Bound", uniform_dist.getLowerBoundAtomic());
        StandardizedBasicTest::printProperty("Atomic Upper Bound", uniform_dist.getUpperBoundAtomic());
        
        // Test setters
        uniform_dist.setLowerBound(-1.0);
        uniform_dist.setUpperBound(2.0);
        StandardizedBasicTest::printProperty("After setting - Lower Bound", uniform_dist.getLowerBound());
        StandardizedBasicTest::printProperty("After setting - Upper Bound", uniform_dist.getUpperBound());
        
        // Test simultaneous parameter setting
        uniform_dist.setParameters(0.0, 5.0);
        StandardizedBasicTest::printProperty("After setParameters - Lower Bound", uniform_dist.getLowerBound());
        StandardizedBasicTest::printProperty("After setParameters - Upper Bound", uniform_dist.getUpperBound());
        
        // Test safe setters (no exceptions)
        auto set_result = uniform_dist.trySetLowerBound(-2.0);
        if (set_result.isOk()) {
            StandardizedBasicTest::printProperty("Safe set lower bound - Lower Bound", uniform_dist.getLowerBound());
        }
        
        set_result = uniform_dist.trySetUpperBound(3.0);
        if (set_result.isOk()) {
            StandardizedBasicTest::printProperty("Safe set upper bound - Upper Bound", uniform_dist.getUpperBound());
        }
        ...
        StandardizedBasicTest::printProperty("CDF(0.0)", test_uniform.getCumulativeProbability(0.0));
        StandardizedBasicTest::printProperty("CDF(1.0)", test_uniform.getCumulativeProbability(1.0));
        ...
        StandardizedBasicTest::printProperty("Support lower bound", test_uniform.getSupportLowerBound());
        StandardizedBasicTest::printProperty("Support upper bound", test_uniform.getSupportUpperBound());
        ...
        cout << "This test verifies random number generation using direct transform method." << endl;
        ...
        StandardizedBasicTest::printProperty("Expected variance ((b-a)²/12)", test_uniform.getVariance());
        ...
        cout << "distribution reset to default (0, 1) parameters, and string representation formatting." << endl;
        ...
        // Test reset
        fitted_dist.reset();
        StandardizedBasicTest::printProperty("After reset - Lower Bound", fitted_dist.getLowerBound());
        StandardizedBasicTest::printProperty("After reset - Upper Bound", fitted_dist.getUpperBound());
