...
int main() {
    ...
    try {
        ...
        cout << "This test verifies all ways to create Exponential distributions: default (1.0), parameterized (2.0)," << endl;
        ...
        StandardizedBasicTest::printProperty("Support lower bound", test_exp.getSupportLowerBound());
        StandardizedBasicTest::printProperty("Support upper bound", test_exp.getSupportUpperBound());
