...
void testUniformCopyMove() {
    ...
    if (result1.isOk() && result2.isOk()) {
        ...
        cout << "  Before copy assignment: uniform2 range [" << uniform2.getLowerBound() << ", "
             << uniform2.getUpperBound() << "]" << endl;

        uniform1 = uniform2;  // This should NOT deadlock

        cout << "  After copy assignment: uniform1 range [" << uniform1.getLowerBound() << ", "
             << uniform1.getUpperBound() << "]" << endl;
    ...
    if (result3.isOk() && result4.isOk()) {
        ...
        cout << "  After move assignment: uniform3 range [" << uniform3.getLowerBound() << ", "
             << uniform3.getUpperBound() << "]" << endl;
...
void testGaussianCopyMove() {
    ...
    cout << "  Before copy assignment: gauss2 N(" << gauss2.getMean() << ", "
         << gauss2.getVariance() << ")" << endl;

    gauss1 = gauss2;  // This should NOT deadlock

    cout << "  After copy assignment: gauss1 N(" << gauss1.getMean() << ", " << gauss1.getVariance()
         << ")" << endl;
    cout << "  ✓ Copy assignment successful" << endl;
    ...
    cout << "  After move assignment: gauss3 N(" << gauss3.getMean() << ", " << gauss3.getVariance()
         << ")" << endl;
    cout << "  ✓ Move assignment successful" << endl;
}
...
void testExponentialCopyMove() {
    ...
    if (result1.isOk() && result2.isOk()) {
        ...
        cout << "  Before copy assignment: exp2 lambda=" << exp2.getLambda()
             << ", mean=" << exp2.getMean() << endl;

        exp1 = exp2;  // This should NOT deadlock

        cout << "  After copy assignment: exp1 lambda=" << exp1.getLambda()
             << ", mean=" << exp1.getMean() << endl;
        cout << "  ✓ Copy assignment successful" << endl;
    }
    ...
    if (result3.isOk() && result4.isOk()) {
        ...
        cout << "  After move assignment: exp3 lambda=" << exp3.getLambda()
             << ", mean=" << exp3.getMean() << endl;
        cout << "  ✓ Move assignment successful" << endl;
    }
}
...
int main() {
    ...
    cout << "This test verifies that the deadlock issue in copy/move assignment has been fixed."
         << endl;
