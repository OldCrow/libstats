...
public:
    ...
    static void printProperty(const std::string& name, double value, int precision = 6) {
        std::cout << name << ": " << std::fixed << std::setprecision(precision) << value << std::endl;
    }
    ...
    static void printSamples(const std::vector<double>& samples, const std::string& prefix = "Samples", int precision = 3) {
        std::cout << prefix << ": ";
    ...
    static void printIntegerSamples(const std::vector<int>& samples, const std::string& prefix = "Integer samples") {
        std::cout << prefix << ": ";
    ...
    static void printBatchResults(const std::vector<double>& results, const std::string& prefix, int precision = 4) {
        std::cout << prefix << ": ";
    ...
    static void printLargeBatchValidation(double firstValue, double lastValue, const std::string& testType) {
        std::cout << "Large batch " << testType << " (first): " << std::fixed << std::setprecision(6) << firstValue << std::endl;
    ...
    static void printCompletionMessage(const std::string& distributionName) {
        std::cout << "\n🎉 All " << distributionName << "Distribution tests completed successfully!" << std::endl;
    }
    ...
    static bool validateSamplesInRange(const std::vector<double>& samples, double minVal, double maxVal) {
    ...
    static std::vector<double> generateDiscreteTestData() {
