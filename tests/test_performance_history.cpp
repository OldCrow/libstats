...
#include "libstats/core/performance_dispatcher.h"  // For Strategy, DistributionType enums
#include "libstats/core/performance_history.h"     // For PerformanceHistory class
