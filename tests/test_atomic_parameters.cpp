...
void test_gaussian_atomic_invalidation() {
    ...
    std::cout << "  ✓ setStandardDeviation() properly invalidates and updates atomic parameters" << std::endl;
    ...
    std::cout << "  ✓ setParameters() properly invalidates and updates atomic parameters" << std::endl;
}
...
void test_exponential_atomic_invalidation() {
    ...
    std::cout << "  ✓ trySetParameters() properly invalidates and updates atomic parameters" << std::endl;
}
...
void test_discrete_atomic_invalidation() {
    ...
    assert(discrete_dist.getUpperBoundAtomic() == 5);
    std::cout << "  ✓ setLowerBound() properly invalidates and updates atomic parameters" << std::endl;
    ...
    std::cout << "  ✓ setUpperBound() properly invalidates and updates atomic parameters" << std::endl;
...
void test_gaussian_atomic_getters() {
    ...
    std::cout << "  ✓ StdDev - Regular: " << stddev_regular << ", Atomic: " << stddev_atomic << std::endl;
}
...
void test_discrete_atomic_getters() {
    ...
    std::cout << "  ✓ Lower - Regular: " << lower_regular << ", Atomic: " << lower_atomic << std::endl;
    std::cout << "  ✓ Upper - Regular: " << upper_regular << ", Atomic: " << upper_atomic << std::endl;
}
...
void test_performance_comparison() {
    ...
    if (atomic_per_call <= regular_per_call * 1.2) {  // Allow 20% margin
        ...
        std::cout << "  ⚠ Atomic getter is slower than expected (this may be normal during testing)" << std::endl;
    }
...
void test_thread_safety() {
    ...
    for (int t = 0; t < num_threads; ++t) {
        threads.emplace_back([&exp_dist, &success_count](int iterations) {
    ...
    std::cout << "  ✓ Thread safety verified with " << (num_threads * iterations_per_thread) << " total operations" << std::endl;
}
