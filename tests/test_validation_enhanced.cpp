...
void test_enhanced_pvalues() {
    ...
    std::cout << "   Statistic: " << std::fixed << std::setprecision(6) << ad_result.statistic
              << std::endl;
    ...
    std::cout << "   Statistic: " << std::fixed << std::setprecision(6) << chi_result.statistic
              << std::endl;
    ...
    std::cout << "   Statistic: " << std::fixed << std::setprecision(6) << chi_extreme.statistic
              << std::endl;
    ...
    std::cout << "   Log-likelihood: " << std::fixed << std::setprecision(3) << diag.log_likelihood
              << std::endl;
    ...
    std::cout << "   Mean residual: " << std::fixed << std::setprecision(6) << mean_residual
              << std::endl;
...
void test_pvalue_accuracy() {
    ...
    for (const auto& test : chi_tests) {
        ...
        std::cout << "   χ²=" << test.chi_sq << ", df=" << test.df << " → p≈" << std::fixed
                  << std::setprecision(4) << " (expected ≈" << test.expected_p << ")" << std::endl;
    }
    ...
    std::cout << "   Perfect fit KS statistic: " << std::fixed << std::setprecision(6)
              << perfect_ks.statistic << std::endl;
...
void test_bootstrap_methods() {
    ...
    if (intervals.size() >= 2) {
        ...
        std::cout << "   Variance CI: [" << intervals[1].lower_bound << ", "
                  ...
                  << "] (point estimate: " << intervals[1].point_estimate << ")" << std::endl;
    }
    ...
    BootstrapTestResult bootstrap_ks_exp =
        bootstrap_kolmogorov_smirnov_test(exp_data, test_gaussian, 100, 0.05);
