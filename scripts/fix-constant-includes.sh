...
#include "../include/core/mathematical_constants.h"  // for detail::ZERO_INT, detail::FOUR_INT' src/simd_dispatch.cpp
fi
...
#include "../include/core/mathematical_constants.h"  // for detail::ZERO_DOUBLE, detail::ONE, detail::TWO\
#include "../include/core/threshold_constants.h"     // for Anderson-Darling thresholds'
fi
...
if ! grep -q "mathematical_constants.h" src/cpu_detection.cpp; then
    sed -i '' '/#include.*platform_constants.h/a\
#include "../include/core/mathematical_constants.h"  // for detail::ZERO_INT, detail::ONE_INT, detail::TWO_INT'
fi
...
#include "../include/core/mathematical_constants.h"  // for detail::ZERO_DOUBLE, detail::ONE'
fi
