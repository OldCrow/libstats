...
void initialize_performance_systems() {
    ...
    try {
        ...
        [[maybe_unused]] const auto& system_capabilities = performance::SystemCapabilities::current();
        ...
        [[maybe_unused]] auto& perf_history = performance::PerformanceDispatcher::getPerformanceHistory();
