...
#if defined(LIBSTATS_HAS_AVX512)
    if (cpu::supports_avx512()) return SIMDPolicy::Level::AVX512;
#endif
#if defined(LIBSTATS_HAS_AVX2)
    if (cpu::supports_avx2()) return SIMDPolicy::Level::AVX2;
#endif
#if defined(LIBSTATS_HAS_AVX)
    if (cpu::supports_avx()) return SIMDPolicy::Level::AVX;
#endif
#if defined(LIBSTATS_HAS_SSE2)
    if (cpu::supports_sse2()) return SIMDPolicy::Level::SSE2;
#endif
#if defined(LIBSTATS_HAS_NEON)
    if (cpu::supports_neon()) return SIMDPolicy::Level::NEON;
#endif
...
std::size_t SIMDPolicy::computeOptimalThreshold(SIMDPolicy::Level level) noexcept {
    switch (level) {
        case SIMDPolicy::Level::AVX512: return 16;
        case SIMDPolicy::Level::AVX2:   return 8;
        case SIMDPolicy::Level::AVX:    return 8;
        case SIMDPolicy::Level::SSE2:   return 4;
        case SIMDPolicy::Level::NEON:   return 4;
...
std::size_t SIMDPolicy::computeOptimalBlockSize(SIMDPolicy::Level level) noexcept {
    switch (level) {
        case SIMDPolicy::Level::AVX512: return 8; // 8 doubles
        case SIMDPolicy::Level::AVX2:   return 4; // 4 doubles
        case SIMDPolicy::Level::AVX:    return 4; // 4 doubles
        case SIMDPolicy::Level::SSE2:   return 2; // 2 doubles
        case SIMDPolicy::Level::NEON:   return 2; // 2 doubles
...
std::size_t SIMDPolicy::computeOptimalAlignment(SIMDPolicy::Level level) noexcept {
    switch (level) {
        case SIMDPolicy::Level::AVX512: return 64;
        case SIMDPolicy::Level::AVX2:   return 32;
        case SIMDPolicy::Level::AVX:    return 32;
        case SIMDPolicy::Level::SSE2:   return 16;
        case SIMDPolicy::Level::NEON:   return 16;
        default:            return 8; // Default alignment for double
    }
}

std::string SIMDPolicy::levelToString(SIMDPolicy::Level level) noexcept {
    switch (level) {
        case SIMDPolicy::Level::AVX512: return "AVX-512";
        case SIMDPolicy::Level::AVX2:   return "AVX2";
        case SIMDPolicy::Level::AVX:    return "AVX";
        case SIMDPolicy::Level::SSE2:   return "SSE2";
        case SIMDPolicy::Level::NEON:   return "NEON";
        default:            return "None";
    }
}
