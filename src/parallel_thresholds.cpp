...
OperationComplexity AdaptiveThresholdCalculator::getOperationComplexity(const std::string& operation) const {
...
DistributionComplexity AdaptiveThresholdCalculator::getDistributionComplexity(const std::string& distribution) const {
