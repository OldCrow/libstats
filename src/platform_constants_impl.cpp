...
namespace simd {
    ...
    std::size_t get_default_block_size() { return DEFAULT_BLOCK_SIZE; }
    std::size_t get_min_simd_size() { return MIN_SIMD_SIZE; }
    std::size_t get_max_block_size() { return MAX_BLOCK_SIZE; }
    std::size_t get_simd_alignment() { return SIMD_ALIGNMENT; }
    ...
    namespace alignment {
        ...
        std::size_t get_avx512_alignment() { return AVX512_ALIGNMENT; }
        std::size_t get_avx_alignment() { return AVX_ALIGNMENT; }
        std::size_t get_sse_alignment() { return SSE_ALIGNMENT; }
        std::size_t get_neon_alignment() { return NEON_ALIGNMENT; }
        std::size_t get_cache_line_alignment() { return CACHE_LINE_ALIGNMENT; }
        std::size_t get_min_safe_alignment() { return MIN_SAFE_ALIGNMENT; }
    }
    ...
    namespace registers {
        ...
        std::size_t get_avx512_doubles() { return AVX512_DOUBLES; }
        std::size_t get_avx_doubles() { return AVX_DOUBLES; }
        std::size_t get_sse_doubles() { return SSE_DOUBLES; }
        std::size_t get_neon_doubles() { return NEON_DOUBLES; }
    }
}
