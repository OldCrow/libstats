...
int main() {
    ...
    std::cout << "     Standard deviation: " << libstats::getStandardDeviation(standard) << " [Expected: 0.2887]" << std::endl;
    std::cout << "     Skewness: " << standard.getSkewness() << " [Expected: 0.0000 - symmetric]" << std::endl;
    std::cout << "     Kurtosis: " << standard.getKurtosis() << " [Expected: 1.8000 - platykurtic]" << std::endl;
    ...
    std::cout << "     Mean: " << custom.getMean() << " [Expected: " << expected_mean << "]" << std::endl;
    std::cout << "     Variance: " << custom.getVariance() << " [Expected: " << expected_var << "]" << std::endl;
    std::cout << "     Standard deviation: " << libstats::getStandardDeviation(custom) << " [Expected: " << std::sqrt(expected_var) << "]" << std::endl;
    std::cout << "     Support: [" << custom.getSupportLowerBound() << ", " << custom.getSupportUpperBound() << "]" << std::endl;
    ...
    std::cout << "   f(x=0.5): " << standard.getProbability(0.5) << " [Within bounds - should be 1.0]" << std::endl;
    std::cout << "   f(x=0.0): " << standard.getProbability(0.0) << " [Lower boundary]" << std::endl;
    std::cout << "   f(x=1.0): " << standard.getProbability(1.0) << " [Upper boundary]" << std::endl;
    std::cout << "   f(x=-0.5): " << standard.getProbability(-0.5) << " [Outside bounds - should be 0.0]" << std::endl;
    
    std::cout << "\n📊 Custom Uniform U(-5,10) PDF evaluations:" << std::endl;
    double expected_density = 1.0 / (10.0 - (-5.0));  // 1/15 ≈ 0.0667
    std::cout << "   f(x=2.5): " << custom.getProbability(2.5) << " [Within bounds - should be " << expected_density << "]" << std::endl;
    std::cout << "   f(x=-5.0): " << custom.getProbability(-5.0) << " [Lower boundary]" << std::endl;
    std::cout << "   f(x=10.0): " << custom.getProbability(10.0) << " [Upper boundary]" << std::endl;
    std::cout << "   f(x=15.0): " << custom.getProbability(15.0) << " [Outside bounds - should be 0.0]" << std::endl;
    ...
    std::cout << "   P(X≤0.25): " << standard.getCumulativeProbability(0.25) << " [Expected: 0.2500]" << std::endl;
    std::cout << "   P(X≤0.50): " << standard.getCumulativeProbability(0.50) << " [Expected: 0.5000]" << std::endl;
    std::cout << "   P(X≤0.75): " << standard.getCumulativeProbability(0.75) << " [Expected: 0.7500]" << std::endl;
    std::cout << "   P(X≤-1.0): " << standard.getCumulativeProbability(-1.0) << " [Expected: 0.0000 - below range]" << std::endl;
    std::cout << "   P(X≤2.0): " << standard.getCumulativeProbability(2.0) << " [Expected: 1.0000 - above range]" << std::endl;
    
    std::cout << "\n📈 Custom Uniform U(-5,10) CDF evaluations:" << std::endl;
    std::cout << "   P(X≤-2.5): " << custom.getCumulativeProbability(-2.5) << " [Expected: " << (-2.5 - (-5.0))/(10.0 - (-5.0)) << "]" << std::endl;
    std::cout << "   P(X≤2.5): " << custom.getCumulativeProbability(2.5) << " [Expected: 0.5000 - at mean]" << std::endl;
    std::cout << "   P(X≤7.5): " << custom.getCumulativeProbability(7.5) << " [Expected: " << (7.5 - (-5.0))/(10.0 - (-5.0)) << "]" << std::endl;
    ...
    std::cout << "   25th percentile: " << standard.getQuantile(0.25) << " [Expected: 0.2500]" << std::endl;
    std::cout << "   50th percentile (median): " << standard.getQuantile(0.5) << " [Expected: 0.5000]" << std::endl;
    std::cout << "   75th percentile: " << standard.getQuantile(0.75) << " [Expected: 0.7500]" << std::endl;
    std::cout << "   95th percentile: " << standard.getQuantile(0.95) << " [Expected: 0.9500]" << std::endl;
    
    std::cout << "\n📊 Custom Uniform U(-5,10) quantiles:" << std::endl;
    std::cout << "   25th percentile: " << custom.getQuantile(0.25) << " [Expected: " << (-5.0 + 0.25 * (10.0 - (-5.0))) << "]" << std::endl;
    std::cout << "   50th percentile (median): " << custom.getQuantile(0.5) << " [Expected: 2.5000]" << std::endl;
    std::cout << "   75th percentile: " << custom.getQuantile(0.75) << " [Expected: " << (-5.0 + 0.75 * (10.0 - (-5.0))) << "]" << std::endl;
