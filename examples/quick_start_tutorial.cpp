...
int main() {
    ...
    std::cout << "   Exponential median (50th percentile): " << exponential.getQuantile(0.5)
              << std::endl;
    ...
    std::cout << "   - Estimated mean: " << fitted_dist.getMean() << " (should be ≈ 5.0)"
              << std::endl;
    ...
    for (size_t i = 0; i < input_values.size(); ++i) {
        std::cout << "   - N(0,1) PDF(" << input_values[i] << ") = " << output_values[i]
                  << std::endl;
    }
