...
private:
    ...
    void print_feature(const std::string& feature, bool available, const std::string& details = "") {
    ...
    void test_threading_functionality() {
        ...
        try {
            ...
            std::cout << "✓ Threading working correctly: " << counter.load() << " threads completed\n";
